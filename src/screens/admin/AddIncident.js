...
import {createIncident} from '../../configs/firebase/collections/incidents.collections';
              ...
              <>
                <View style={common.customInput}>
                  ...
                  <DropDownPicker
                    ...
                    listMode="SCROLLVIEW"
                  />
                  {!categoryValue && touched.category && (
                ...
                {!downloadURL && (
                  <View>
                    <TouchableHighlight
                      ...
                      underlayColor="#20AC6A">
                      <Text style={buttons.buttonText}>Upload a Photo</Text>
                    </TouchableHighlight>
                  </View>
                )}
              </>
